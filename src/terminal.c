...
int takeInput(char* str){
	...
	char *cmd_info = (char*)malloc(1024 * sizeof(char));
	sprintf(cmd_info, "%s:%s $", username, cwd);
...
void* date_cmd(void* arg){
	...
	system("/home/manvi-agrawal/Linux-Shell-Creation/build/output/date_cmd");  
    pthread_exit(NULL);
}
...
void* date_cmd_1arg(void* arg){
    ...
    pthread_detach(pthread_self());
	char binaryFile[] = "/home/manvi-agrawal/Linux-Shell-Creation/build/output/date_cmd ";
...
void* mkdir_cmd_1arg(void* arg){
	char* parsed = (char*) arg;
    pthread_detach(pthread_self());
	char binaryFile[] = "/home/manvi-agrawal/Linux-Shell-Creation/build/output/mkdir_cmd ";
	strcat(binaryFile,parsed);
	system(binaryFile);  
    pthread_exit(NULL);
}
...
void* mkdir_cmd_v(void* arg){
	char* parsed = (char*) arg;
    pthread_detach(pthread_self());
	char binaryFile[] = "/home/manvi-agrawal/Linux-Shell-Creation/build/output/mkdir_cmd -v ";
	strcat(binaryFile,parsed);
	system(binaryFile);  
    pthread_exit(NULL);
}
...
void* mkdir_cmd_p(void* arg){
	char* parsed = (char*) arg;
    pthread_detach(pthread_self());
	char binaryFile[] = "/home/manvi-agrawal/Linux-Shell-Creation/build/output/mkdir_cmd -p ";
	strcat(binaryFile,parsed);
	system(binaryFile);  
    pthread_exit(NULL);
}
...
void* rm_cmd_1arg(void* arg){
	char* parsed = (char*) arg;
    pthread_detach(pthread_self());
	char binaryFile[] = "/home/manvi-agrawal/Linux-Shell-Creation/build/output/rm_cmd ";
	strcat(binaryFile,parsed);
	system(binaryFile);
    pthread_exit(NULL);
}
...
void* rm_cmd_i(void* arg){
	char* parsed = (char*) arg;
    pthread_detach(pthread_self());
	char binaryFile[] = "/home/manvi-agrawal/Linux-Shell-Creation/build/output/rm_cmd -i ";
	strcat(binaryFile,parsed);
	system(binaryFile);
    pthread_exit(NULL);
}
...
void* rm_cmd_v(void* arg){
	char* parsed = (char*) arg;
    pthread_detach(pthread_self());
	char binaryFile[] = "/home/manvi-agrawal/Linux-Shell-Creation/build/output/rm_cmd -v ";
	strcat(binaryFile,parsed);
	system(binaryFile);
    pthread_exit(NULL);
}
...
void* cat_cmd_1arg(void* arg){
	char* parsed = (char*) arg;
    pthread_detach(pthread_self());
	char binaryFile[] = "/home/manvi-agrawal/Linux-Shell-Creation/build/output/cat_cmd ";
	strcat(binaryFile,parsed);
	system(binaryFile);
    pthread_exit(NULL);
}
...
void* cat_cmd_n(void* arg){
	char* parsed = (char*) arg;
    pthread_detach(pthread_self());
	char binaryFile[] = "/home/manvi-agrawal/Linux-Shell-Creation/build/output/cat_cmd -n ";
	strcat(binaryFile,parsed);
	system(binaryFile);
    pthread_exit(NULL);
}
...
void* cat_cmd_E(void* arg){
	char* parsed = (char*) arg;
    pthread_detach(pthread_self());
	char binaryFile[] = "/home/manvi-agrawal/Linux-Shell-Creation/build/output/cat_cmd -E ";
	strcat(binaryFile,parsed);
	system(binaryFile);
    pthread_exit(NULL);
}
...
void* ls_cmd(void* arg){
	...
	system("/home/manvi-agrawal/Linux-Shell-Creation/build/output/ls_cmd");  
    pthread_exit(NULL);
}
...
void* ls_cmd_1arg(void* arg){
	char* parsed = (char*) arg;
    pthread_detach(pthread_self());
	char binaryFile[] = "/home/manvi-agrawal/Linux-Shell-Creation/build/output/ls_cmd ";
	strcat(binaryFile,parsed);
	system(binaryFile);
    pthread_exit(NULL);
}
...
int externalCommandHandler_usingFork(char** parsed){
    ...
    if (pid < 0) {
        ...
        case 1:		//ls
			if (sizeof(parsed)==1){
            	execl("/home/manvi-agrawal/Linux-Shell-Creation/build/output/ls_cmd",NULL);
			}
			else{
				execl("/home/manvi-agrawal/Linux-Shell-Creation/build/output/ls_cmd",parsed[0],parsed[1],NULL);
			}
            break;
        case 2:		//mkdir
			if (parsed[1]==NULL){
            	...
            	execl("/home/manvi-agrawal/Linux-Shell-Creation/build/output/mkdir_cmd",parsed[0],parsed[1],NULL);
			}
			else if (parsed[3]==NULL){
				execl("/home/manvi-agrawal/Linux-Shell-Creation/build/output/mkdir_cmd",parsed[0],parsed[1],parsed[2],NULL);
			}
			else{
        ...
        case 3:		//date
            if (sizeof(parsed)==1){
            	execl("/home/manvi-agrawal/Linux-Shell-Creation/build/output/date_cmd",NULL);
			}
			else{
				execl("/home/manvi-agrawal/Linux-Shell-Creation/build/output/date_cmd",parsed[0],parsed[1],NULL);
			}
            break;
        case 4:		//cat
			if (parsed[1]==NULL){
            	...
            	execl("/home/manvi-agrawal/Linux-Shell-Creation/build/output/cat_cmd",parsed[0],parsed[1],NULL);
			}
			else if (parsed[3]==NULL){
				execl("/home/manvi-agrawal/Linux-Shell-Creation/build/output/cat_cmd",parsed[0],parsed[1],parsed[2],NULL);
			}
			else{
				// printf("size: %d ",sizeof(parsed));
				// printf("0: %s , 1: %s ",parsed[0],parsed[1]);
        ...
        case 5:		//rm
			if (parsed[1]==NULL){
            	...
            	execl("/home/manvi-agrawal/Linux-Shell-Creation/build/output/rm_cmd",parsed[0],parsed[1],NULL);
			}
			else if (parsed[3]==NULL){
				execl("/home/manvi-agrawal/Linux-Shell-Creation/build/output/rm_cmd",parsed[0],parsed[1],parsed[2],NULL);
			}
			else{
				// printf("size: %d ",sizeof(parsed));
				// printf("0: %s , 1: %s ",parsed[0],parsed[1]);
